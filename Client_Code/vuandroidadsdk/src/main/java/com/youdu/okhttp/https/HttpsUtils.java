package com.youdu.okhttp.https;
...
public class HttpsUtils {
    ...
    public static SSLSocketFactory initSSLSocketFactory() {
        SSLContext sslContext = null;   //2、创建加密上下文
        try {
            sslContext = SSLContext.getInstance("SSL"); //这里采取的算法需要与服务器的算法一致，SSL或者TSL
            X509TrustManager[] xTrustArray = new X509TrustManager[]     //1 生成一个信任管理器类
                    {initTrustManager()};
